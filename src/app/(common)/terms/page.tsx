        ...
        <div className="rw-container text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose lg:prose-lg">
                ...
                <p className="rw-bodycopy2 my-3">
                Mova provides AI-powered creative tools and services including but not limited to:
                </p>
                ...
                <p className="rw-bodycopy2 my-3">
                7.1 The Service and its original content are proprietary to Mova.
                </p>
                <p className="rw-bodycopy2 my-3">
                ...
                <p className="rw-bodycopy2 my-3">
                Mova and its affiliates shall not be liable for any indirect, incidental or consequential damages resulting from Service use.
                </p>
                ...
                <p className="rw-bodycopy2 my-3">
                For questions about these Terms, please contact us at support@mova.com.
                </p>
            </div>
          </div>
        </div>
